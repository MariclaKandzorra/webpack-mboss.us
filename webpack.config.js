...
module.exports = {
    ...
    entry: {     
		...
		'/application/core/homepage/silopages/services/search/search.js': './src/application/core/homepage/silopages/services/search/search.js',
	...
	output: {
		...
		publicPath: '/',
		assetModuleFilename: 'assets/img/[name]?[hash]',
		clean: true,
    },
	// Optimizations
	optimization: {
